...
.delaction a{  border: 1px solid #ddd;
  color: #444;
  cursor: pointer;
  font-size: 20px;
  padding: 2px 10px;
...
<?php
 if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($name == "" || $body == "") {
         echo "<span class= 'error'>Field not successfully fieled!!!!</span>";
...
?>     
            <div class="block">   
                 ...
                 <?php  
                        ...
                        $getquery = "SELECT * FROM tbl_page WHERE id = '$id'";
                        $pagedetails = $db->select($getquery);
                        if ($pagedetails) {
