                ...
                <div class="block">        
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td><?php echo $fm->textShort($result['body'],60);?></td>
							<td><?php echo $fm->formatDate($result['date']);?></td>
							<td>
								<a href="viewmsg.php?msgid=<?php echo $result['id'];?>">View</a> ||
								<a href="replymsg.php?msgid=<?php echo $result['id'];?>">Reply</a> ||
								<a onclick="return confirm('ARE YOU SURE TO Move The File to SEEN BOX?!!!');" href="?seenid=<?php echo $result['id'];?>">Seen</a> 
							</td>
						</tr>
	...
	$deldata = $db->delete($query);
	 ...
	 if ($deldata) {
       echo "<span class= 'success'>Message successfully deleted!!!!</span>";
		...
		echo "<span class= 'success'>Message  Not successfully deleted!!!!</span>";
  }
